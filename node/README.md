...
curl -X POST --header 'Content-Type:application/json' --header 'x-header: olcay' --data '{"name": "donnieraycrisp"}' 'http://localhost:8080/activities/557c52f1917227de3237826c/invite' -vvv
```
